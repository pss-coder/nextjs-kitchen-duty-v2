                    ...
                    { 
                        rosters.map((roster, rosterIndex) => (
                            <tr key={roster["Week"]} className="flex flex-col flex-no wrap sm:table-row mb-2 sm:mb-0">
                                ...
                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Mop and Wipe the floor"]}</td>
                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Empty Paper Bin"]}</td>
                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Empty Plastic Bin"]}</td>
                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Empty Domestic Waste"]}</td>
                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Empty Metal and Glass"]}</td>

                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Supervise tables"]}</td>
                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Supervise stoves"]}</td>
                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Supervise drying rack"]}</td>
                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Supervise cleaning tools ( to top up )"]}</td>
                                <td className="font-bold text-center border-grey-light border hover:bg-gray-100 p-3">{roster["Supervise counters and sinks"]}</td>
    ...
    return (
        <div className={styles.container}>
            ...
            <footer className={styles.footer}>
                <p>Powered by your friendly neighbor from Singapore 🇸🇬
